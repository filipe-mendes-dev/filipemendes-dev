...
export const themeTokenSets: Record<ThemeName, ThemeTokens> = {
  light: {
    ...
    stone: '#e7e4dc',
    'chip-bg': '#eeebe3',
    'button-secondary-bg': '#ece8df',
    'header-bg': 'rgb(249 247 242 / 92%)',
    'footer-bg': '#ddd7ce',
    'hero-home-bg': '#f3f1ec',
    'hero-projects-bg': '#ebe6dd',
    'hero-about-bg': '#f1ede5',
    'hero-contact-bg': '#e7e1d8',
    'accent-soft': 'rgb(44 90 160 / 22%)',
    'moss-faint': 'rgb(44 90 160 / 14%)',
    'signal-red': '#f47f7c',
    ...
    'moss-strong': '#1D4685',
    clay: '#8EAAD4',
    line: 'rgb(35 39 42 / 22%)',
    'shadow-tint': '0 20px 40px rgb(35 39 42 / 11%)',
    ...commonThemeTokens,
  },
  dark: {
    paper: '#040506',
