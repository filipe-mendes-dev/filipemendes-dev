...
export const nearsoftMobileAppsAppPublishingPolicy: Doc = {
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            'Screenshots must represent the actual release experience, supported locales, and the device families being targeted.',
