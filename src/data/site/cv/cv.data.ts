...
import { experienceData, type ExperienceId } from "../experience.data";
...
const frontendBulletHighlights: Record<ExperienceId, string[][]> = {
  acin: [
    ...
    ["responsive", "accessible interfaces", "semantic HTML", "adaptive CSS"],
    ["GraphQL", "reusable React components"],
    ["Cursor", "GitHub Copilot"],
  ],
  nearsoft: [
    ["React Native", "TypeScript", "REST APIs"],
    ["reusable React Native components", "Redux"],
    ["responsive mobile interfaces", "iOS", "Android"],
    ["mentored a frontend intern", "Git"],
...
> = {
  ...
  inov: {
    bulletHighlights: [
      ...
      ["annotation, preprocessing and data augmentation", "model training"],
      ["Evaluated model performance", "generalization issues"],
      ["C#/OpenCV", "real-time inference"],
    ],
    bullets: [
      "Developed and trained neural networks in Python with TensorFlow and Keras, experimenting with architectures, training configurations and hyperparameters to identify the best-performing models.",
...
export const frontendCvData: CvDocumentData = {
  ...
  personalInfo: {
    ...
    summary:
      "Frontend Engineer with around 4 years of software development experience and an MSc in Engineering Physics. Built healthcare and banking applications with React, React Native and TypeScript, and independently developed and released an iOS and Android app.",
  },
...
export const fullStackCvData: CvDocumentData = {
  ...
  personalInfo: {
    ...
    title: "Software Engineer",
    summary:
      "Software Engineer with around 4 years of experience across frontend, mobile and applied machine learning, with an MSc in Engineering Physics. Built healthcare and banking applications with React, React Native and TypeScript, with earlier experience developing computer vision systems in Python.",
  },
